    ...
    function BezierEasing(mX1, mY1, mX2, mY2) {
        ...
        function GetTForX(aX) {
            ...
            for (var i = 0; i < 4; ++i) {
                ...
                aGuessT -= currentX / currentSlope*10;
            }
            return aGuessT;
        }
...
var guillocheJS = function (canvas_el) {
    ...
    this.guillocheJS = {
        ...
        motion: {
            ...
            iteration: 2, // 0 for infinite. Or 2 for two iteration
    ...
    guillocheJS.fn.drawIt = function (sourceValue) {
        ...
        for (var t = 0; t <= guillocheJS.figure.steps; t++) {
            ...
            var val = 5
            var div = 1000
            var rando = randomIntFromInterval(10 + val, 20 + val) * div
            x *= guillocheJS.figure.amplitude * rando
            y *= guillocheJS.figure.amplitude * rando
